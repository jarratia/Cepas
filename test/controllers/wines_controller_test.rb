...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { name: @wine.name, qualification: @wine.qualification } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { name: @wine.name, qualification: @wine.qualification } }
