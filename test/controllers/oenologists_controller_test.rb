...
class OenologistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create oenologist" do
    assert_difference('Oenologist.count') do
      post oenologists_url, params: { oenologist: { age: @oenologist.age, magazine_id: @oenologist.magazine_id, name: @oenologist.name, nationality: @oenologist.nationality } }
    end
  ...
  test "should update oenologist" do
    patch oenologist_url(@oenologist), params: { oenologist: { age: @oenologist.age, magazine_id: @oenologist.magazine_id, name: @oenologist.name, nationality: @oenologist.nationality } }
